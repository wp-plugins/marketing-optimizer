...
<div class="wrap">
	...
	<div style="width: 80%">
		<h2 class="nav-tab-wrapper">
			<a href="?page=marketing-optimizer-settings&tab=mo_lp_general_settings" class="nav-tab <?php echo $active_tab == 'mo_lp_general_settings' ? 'nav-tab-active' : ''; ?>">General
				Settings</a>
				<a href="?page=marketing-optimizer-settings&tab=mo_integration_settings" class="nav-tab  <?php echo $active_tab == 'mo_integration_settings' ? 'nav-tab-active' : ''; ?>">Marketing
				Optimizer Integration</a>
				<a href="?page=marketing-optimizer-settings&tab=mo_gf_integration" class="nav-tab  <?php echo $active_tab == 'mo_gf_integration' ? 'nav-tab-active' : ''; ?>">Gravity Forms Integration</a>
		</h2>
		<div style="padding: 20px; background-color: #ECECEC;border-left:1px solid #ccc;border-right:1px solid #ccc;border-bottom:1px solid #ccc;">
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td style="width: 50%"><p>
								...
								required for the all Marketing Optimizer plugin functionality to
								work.
							</p></td>
					</tr>
				</table>
